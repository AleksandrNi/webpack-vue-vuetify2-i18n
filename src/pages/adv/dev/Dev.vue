    ...
    methods: {
        handleScroll (event) {
            ...
            if (slideContainerCurrentTop - slideContainerTopPadding  > 0) {
                ...
                // check start end condiotions
                if(this.scrollEnterPoint === this.scroll) {
                    slideContainer.style.left = this.slideContainerOffsetLeft
                }
                if(this.scrollExitPoint === this.scroll) {
                    slideContainer.style.left = this.slideContainerOffsetLeft - slideWidth;
                }
            } 
        },
